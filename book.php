...
<body>
  ...
  <section class="main-heading   text-danger" id="contactus">
       <div class="pl-5 pt-5">
       <a href="./profile.php"> <button type="submit" name="back" class="btn btn-success">Back To Previous Page</button></a><br><br>
       </div>
       
    <div class="text-center text-danger">
        <h1 class="display-4 text-red">Book Hostel</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xxl-8 col-10 col-md-8 mx-auto">
            <form action="./bookingReg.php" method="post" autocomplete="off">
